...
folder_path = "C:/Users/moons/OneDrive/Desktop/CMAA-Daisi/Bot_Cleaning"
...
def process_excel_file(file_path):
    ...
    cleaned_data_frame = cleaning_chatbot.clean_data(retrieved_data)
    organized_data_frame = cleaning_chatbot.organize_data(cleaned_data_frame)

    # Export the cleaned and organized data to a new Excel file
    output_file = "output.xlsx"  # Modify this as needed
    output_folder = "output_folder"  # Modify this as needed
    cleaning_chatbot.export_data(organized_data_frame, output_file, output_folder)
...
class ExcelScrapingChatbot:
    ...
    def retrieve_data(self, sheet_name, columns, start_row=None, end_row=None):
